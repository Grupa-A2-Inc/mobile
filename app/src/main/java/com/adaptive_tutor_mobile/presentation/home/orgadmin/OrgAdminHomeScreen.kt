package com.adaptive_tutor_mobile.presentation.home.orgadmin
...
private val orgAdminCards = listOf(
    ActionCard("Utilizatorii mei",  "GET /api/v1/users/organization",  Icons.Filled.Group),
    ActionCard("Săli de clasă",     "GET /api/v1/classrooms",          Icons.Filled.Class),
    ActionCard("Crează sală",       "POST /api/v1/classrooms",         Icons.Filled.School),
    ActionCard("Adaugă utilizator", "POST /api/v1/users",              Icons.Filled.PersonAdd)
)

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun OrgAdminHomeScreen(
    ...
    val firstName = currentUser?.firstName ?: "Admin Org"
